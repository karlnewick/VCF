...
$ESXiHosts = @(
    "fx-2-mgmt-esx-1.wei-lab.com",
    "fx-2-mgmt-esx-2.wei-lab.com",
    "fx-2-mgmt-esx-3.wei-lab.com",
    "fx-2-mgmt-esx-4.wei-lab.com"
)

$CorrectDNS = @("10.11.92.23","10.11.92.24")
$CorrectNTP = @("10.11.92.23","10.11.92.24")
$Domain     = "wei-lab.com"

# Optional readiness baselines. Leave blank to report actual values without enforcing a match.
$ExpectedMgmtGateway   = ""
$ExpectedMgmtVlanId    = ""
...
# Revert-specific — must match your VCF deployment JSON (dvsSpecs.dvsName and MANAGEMENT vlanId)
